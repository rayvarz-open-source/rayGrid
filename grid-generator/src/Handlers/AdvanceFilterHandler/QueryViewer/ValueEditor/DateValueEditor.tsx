...
export function DateValueEditor(props: Props) {
  ...
  return (
    <MuiPickersUtilsProvider
      utils={
        props.expression.extras.field.type.name === FieldSchemaTypeName.GregorianDateTime ? MomentUtils : JalaliUtils
      }
    >
      <DatePicker
        clearable={false}
        format={
          props.expression.extras.field.type.name === FieldSchemaTypeName.GregorianDateTime
            ? 'YYYY/MM/DD'
            : 'jYYYY/jM/jD'
        }
        style={styles}
