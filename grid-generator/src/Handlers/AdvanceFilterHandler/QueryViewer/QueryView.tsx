  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.actionBarContainer}>
        <Button
          onClick={() => advanceFilterContext.contentProps?.onApply([advanceFilterContext.rootExpression])}
          variant={'contained'}
          color={'primary'}
        >
          {advanceFilterContext.contentProps?.localization.apply}
        </Button>
        <Button
          onClick={() => advanceFilterContext.contentProps?.onCancel()}
          variant={'text'}
          color={'default'}
          style={{ marginRight: 5, marginLeft: 5 }}
        >
          {advanceFilterContext.contentProps?.localization.cancel}
        </Button>
      </div>
    </div>
  );
