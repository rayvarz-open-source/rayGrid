              ...
              GridGenerator({
                dataSource: (options) => {
                  if (props.options.listFilterDataSource == null)
                    throw new TypeError(
                      "options.listFilterDataSource does not have value."
                    );
                  ...
                  customActionsController: new BehaviorSubject<Action<any>[]>([
                    {
                      ...
                      onClick: (_event, model) => {
                        ...
                        props.elements.listFilterModal.openContainer.next(
                          false
                        );
                      },
                    },
